---
layout: base.njk
title: "On building a home on the web (III)"
bodyClass: bg-stone
date: 2026-09-08T00:05:23+02:00
tags: [internet, development]
image:
  src: /assets/journal/daniel-pizza-3.png
  alt: "This website"
  title: "On building a home on the web (III)"
...
{% bookmark
  url="/journal/camp-day-one/",
  title="Aulus-les-Bains (I)",
  description="The first day of my weeklong writing residency at Camp, in
    Aulus-les-Bains.",
  image="/assets/journal/aulus-les-bains01.JPG",
  imageAlt="Aulus-les-Bains"
%}

On the [Links page](/links/ "My Links"), my blog of sorts, I’ve published eighty-five new links since the launch, on top of the fifty-five that were already there. The page had lain dormant for five months before that; then sixteen appeared in August alone. Having a new space I enjoyed working in restarted the habit.
...
{% bookmark
  url="/photos/",
  title="Photos",
  description="Taken with an Olympus AF-10 and an AF-10 Super, usually on
    Kodak Ultramax, and never edited.",
  image="/assets/photos/alley-and-gable.png",
  imageAlt="Black and white: a narrow brick alley looking towards a tall
...
That’s the whole point, really. It’s one thing to drop a resource into a social feed; it’s another to have a page where it stays, where three students can find it months later and pass it on in a guide of their own. I learned most of my trade the same way, twenty-odd years ago—browsing from website to website, day after day. It’s good to remember the web can still work like that, if you let it.

Matthias Ott made a version of this argument in 2019, in [_Into the Personal-Website-Verse_](https://matthiasott.com/articles/into-the-personal-website-verse?ref=daniel.pizza "Matthias Ott on the personal web"), and has kept making it since. His case isn’t only that you should own your corner of the web; it’s that these corners should point to one another. That the acknowledging, and arguing, and building-upon we outsourced to timelines can happen between sites instead, one link at a time.

{% bookmark
  url="https://matthiasott.com/articles/into-the-personal-website-verse?ref=daniel.pizza",
  title="Into the Personal-Website-Verse",
  description="Matthias Ott on why personal websites matter, and why they
    should point to one another.",
  icon="/assets/bookmarks/icons/matthiasott.png",
  image="/assets/bookmarks/into-the-personal-website-verse.jpg",
  imageAlt="Into the Personal-Website-Verse"
%}
