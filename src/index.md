...
<section class="resume">
  ...
  <div class="flex flex-col">
    ...
    <div class="flex items-baseline border-b border-black/10 dark:border-white/10">
      ...
      <p class="my-4">Designer and Head of <a href="https://bakkenbaeck.com?ref=daniel.pizza" title="Bakken &amp; Bæck" rel="nofollow" target="_blank">Bakken &amp; Bæck</a> Amsterdam</p>
    </div>
    <div class="flex items-baseline border-b border-black/10 dark:border-white/10">
