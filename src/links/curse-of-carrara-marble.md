---
layout: narrow.njk
title: "The Curse of Carrara Marble"
date: 2025-07-30
tags: [nature]
external_url: https://www.thedial.world/articles/news/issue-30/carrara-marble-mining?ref=daniel.pizza
bodyClass: bg-green
---
<h1><a href="{{ external_url }}">{{ title }}</a></h1>

{% retinaImage "src/assets/links/carrara-marble.webp", "Carrara marble" %}

A scene from [_The Brutalist_](https://letterboxd.com/film/the-brutalist/ "The Brutalist on Letterboxd"), perhaps:
