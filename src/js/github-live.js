  ...
  renderCalendar() {
    ...
    const calendarHTML = `
      <div class="github-calendar w-full relative">
        <div id="github-tooltip" class="absolute hidden bg-gray-900 dark:bg-neutral-700 text-white text-xs font-sans px-2 py-1 rounded shadow-lg pointer-events-none z-50 whitespace-nowrap"></div>
